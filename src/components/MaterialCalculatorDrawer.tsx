  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-accent text-accent-foreground pl-5 pr-6 py-3.5 rounded-full shadow-xl hover:shadow-2xl hover:scale-105 transition-all font-display text-sm uppercase tracking-wider animate-pulse hover:animate-none ring-2 ring-accent/30 ring-offset-2 ring-offset-background"
      >
